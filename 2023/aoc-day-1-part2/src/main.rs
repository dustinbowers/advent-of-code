...
fn main() {
    let fixed_input = replace_words_with_numbers(INPUT.to_string());
    let lines: Vec<String> = fixed_input.lines().map(String::from).collect();
    let mut total: u32 = 0;
...
const INPUT: &str = "two65eightbkgqcsn91qxkfvg
